    ...
    <div>
      ...
      <div className="audit-container ">
        <div className="audit-text">
          ...
          <p>The customs duty rates on imported goods are: </p>
          <ul>
            <li>
              1. 5% on CIF (Cost, Insurance, and Freight) value of all foreign
              goods imported from outside the Customs Union.
            </li>
            <li>
              2. 100% ad valorem or specific duty (whichever is higher) on the
              value or quantity/weight for tobacco and related products.
            </li>
      ...
      <div className="audit-container conclu-container">
        <div className="audit-text">
          ...
          <p>
            Businesses licensed by a competent authority in the UAE or other GCC
            states can register with the Customs Department by specifying the
            type of business they operate. Upon registration, the business will
            be provided with a unique identification code, linked to the
      ...
      <div className="audit-container conclu-container">
        <div className="audit-text">
          ...
          <p>
            Registered businesses are required to file detailed customs
            declarations to clear goods. In cases where approval from the Tax
            Authority is necessary, it must also be submitted to the Customs
            Authority for proper clearance.{" "}
          </p>
        </div>
      </div>
      <div className="audit-container conclu-container">
        <div className="audit-text">
          ...
          <p>
            The Customs Authority conducts audits on all transactions to ensure
            compliance with the law. Audits can be initiated by the Customs
            Department or requested by the registered entity. Regular audits
            help businesses avoid fines and penalties by keeping records
            reconciled.{" "}
          </p>
        </div>
      </div>
      <div className="audit-container conclu-container">
        <div className="audit-text">
          ...
          <p>
            All documents related to customs declarations must be retained for 5
            years from the date of clearance. The Customs Authority may request
            relevant documents such as contracts and correspondence, regardless
            of the information stated in the declarations or invoices. For Free
            Zone Customs Declarations, documents must be retained until the
            completion of the economic operations in the free zone.
          </p>
        </div>
      </div>
      <div className="call">

            ...
            <div className="col-12 col-lg-6 col-xl-7">
              <div className="row justify-content-xl-between">
                <div className="col-12 col-xl-11">
                  ...
                  {/* <p className="mb-5 ">
                  DSB Chartered Accountants in Dubai excels in delivering expert
                  auditing services and dynamic business development solutions.
                  Our team combines rigorous financial analysis with strategic
                  insights to help businesses thrive in a competitive landscape.
                  With a commitment to excellence, we provide tailored services
                  that drive growth and ensure financial integrity. Trust us to
                  be your partner in achieving lasting success and navigating
                      ...
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">
                            ...
                            services, ensuring truthful and reliable
                            information.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="col-12 col-md-6 ">
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">
                            We protect client information with the highest level
                    ...
                    <div className="col-12 col-md-6 codePoints ">
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="text-secondary mb-0">
                            We take full responsibility for our actions and
                            ensure compliance with ethical standards and legal
                            requirements
                          </p>
                        </div>
                      </div>
